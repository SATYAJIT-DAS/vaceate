...
[![Build Status](https://travis-ci.org/Cypretex/chat.svg?branch=master)](https://travis-ci.org/Cypretex/chat)
[![Downloads](https://img.shields.io/packagist/dt/Cypretex/chat.svg)](https://packagist.org/packages/Cypretex/chat)
[![Packagist](https://img.shields.io/packagist/v/Cypretex/chat.svg)](https://packagist.org/packages/Cypretex/chat)
## Chat
...
```
composer require Cypretex/chat
```

Add the service provider to your `config\app.php` the providers array

```
Cypretex\Chat\ChatServiceProvider::class
```

Add the Facade to your aliases:

```
'Chat' => Cypretex\Chat\Facades\ChatFacade::class to your `config\app.php`
```
...
This will publish database migrations and a configuration file `Cypretex_chat.php` in the Laravel config folder.
...
[
     ...
     * Event: Cypretex\Chat\Messages\MessageWasSent
     */
    'broadcasts'            => false,
];
```
...
However, you can update the user model in `Cypretex_chat.php` published in the `config` folder.
