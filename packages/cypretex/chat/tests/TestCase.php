...
class TestCase extends \Orchestra\Testbench\TestCase
{
    ...
    protected function getEnvironmentSetUp($app)
    {
        ...
        $app['config']->set('Cypretex_chat.user_model', 'Cypretex\Chat\User');
        $app['config']->set('Cypretex_chat.broadcasts', false);
    }
    ...
    {
        return [
            'Chat' => \Cypretex\Chat\Facades\ChatFacade::class,
        ];
    }
