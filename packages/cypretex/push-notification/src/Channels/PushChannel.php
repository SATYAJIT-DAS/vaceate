...
use Cypretex\PushNotification\Events\NotificationPushed;
...
abstract class PushChannel
{
    ...
    {
        if (! $to = $notifiable->routeNotificationFor($this->notificationFor(), $notification)) {
            return;
        }
     ...
     * @param  mixed $to
     * @param  array $data
     * @param  \Cypretex\PushNotification\Messages\PushMessage $message
     * @return mixed
     */
     ...
     * @param  mixed $notifiable
     * @param  \Illuminate\Notifications\Notification  $notification
     * @return \Cypretex\PushNotification\Messages\PushMessage
     */
