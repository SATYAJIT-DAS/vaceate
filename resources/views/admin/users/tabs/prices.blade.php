<form class="form form-horizontal form-enterkey" method="POST" action="{{ route('admin.users.prices-store', ['id'=>$model->id]) }}" autocomplete="off" enctype="multipart/form-data">
    {{ method_field('PUT') }}
    @csrf
