...
return [
    ...
    'user_unique_phone'=>'Ya existe un usuario con este teléfono.',
    /*
      |--------------------------------------------------------------------------
    ...
    'custom' => [
        ...
        'g-recaptcha-response' => [
            ...
            'captcha' => 'Captcha error! intente nuevamente o contacte al administrador.',
        ],
        'wrong_address' => [
            'valid' => 'La dirección no es válida!',
            'unique' => 'La dirección ya está en uso!'
        ],
